...
interface Version extends core.Types.Version {
  code: string;
}
...
const sysMajorVer = core.platform.version.major;
const sysMinorVer = core.platform.version.minor;
const sysPatchVer = core.platform.version.patch;
...
class System extends EventTarget implements SystemAPI {
  ...
  constructor() {
    super(core.notifications.addEventListener);
  }

  getApplications(): Array<Application> {
    return core.applications.getApplications().map(application => {
