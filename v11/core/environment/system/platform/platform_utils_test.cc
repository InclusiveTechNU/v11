...
#include "core/environment/system/platform/platform_utils.h"
...
TEST(V11CoreSysPlatformUtilsTest, StringToVersionStandard) {
...
TEST(V11CoreSysPlatformUtilsTest, StringToVersionSomeAlphaText) {
...
TEST(V11CoreSysPlatformUtilsTest, StringToVersionBadStart) {
